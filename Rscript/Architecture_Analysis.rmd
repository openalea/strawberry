...
```{r Plot distribution of one variable for each module orders}
...
For this, we used a recursive pooling of samples from the highest prder downward if sample size =< 8
...
tab4<- fc_dist_module_by_order(data = dat_group)
...
```{r Pointwise Mean of variable of modules for successive orders for each varieties}
