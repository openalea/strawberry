...
- A `PDF <../latex/strawberry.pdf>`_ version of |strawberry| documentation is 
  available.

.. seealso::

   More documentation can be found on the
   `openalea <http://openalea.gforge.inria.fr/dokuwiki/doku.php?id=packages::strawberry:strawberry>`__ wiki.
