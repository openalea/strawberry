...
tab_single_genotype_content = v.Row(children=[v.Card(style_=layout_card, children=[info.p4_doc_single]),
...
tab_waffle_content = v.Row(children=[v.Card(style_=layout_card, children=[info.p4_doc_waffle]),
                                v.Col(col=12, sm=12, md=12, children=[
                                    menu_plant_waffle,
                                    waffle,
                                ]),
