...
# * name is the full name (e.g., Strawberry) whereas pkg_name is only 'strawberry'
...
setup(
    ...
    entry_points = { 
        'wralea' : ['strawberry = .strawberry_wralea' if has_project else 'strawberry = strawberry_wralea' ],
        #'console_scripts': [
